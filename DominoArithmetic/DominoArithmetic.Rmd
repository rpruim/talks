 ...
 * U(n) = listing (set) of all tilings of a 3 $\times$ n rectangle
 * u(n) = |U(n)|
...
* So it isn't possible to tile a 3 $\times$ n rectangle with dominos.
 ...
 * T(n) = listing (set) of all tilings of a 2 $\times$ n rectangle
 * t(n) = |T(n)|
...
<!-- > Arithmetic (from the Greek ἀριθμός arithmos, "number" and τική [τέχνη], tiké -->
...
> Arithmetic is a branch of mathematics that consists of the study of
...
<tr>
<td>1 - <svg width="15" height="30" style="background: rgb(255, 255, 255); fill: rgb(0, 0, 0); color: rgb(0, 0, 0);">
<rect rx="2" ry="2" x="1" y="1" width="13" height="28" fill="skyblue" fill-opacity="0.5" stroke="black">
</rect>
</svg> 
-
...
<div class = "domalgebra">
x = <svg width="15" height="30" style="background: rgb(255, 255, 255); fill: rgb(0, 0, 0); color: rgb(0, 0, 0);">
<rect rx="2" ry="2" x="1" y="1" width="13" height="28" fill="skyblue" fill-opacity="0.5" stroke="black">
</rect>
</svg>
and y = 
