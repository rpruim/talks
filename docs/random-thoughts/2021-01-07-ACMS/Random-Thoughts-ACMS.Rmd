...
date: "2021/01/21 (updated: `r Sys.Date()`)"
output:
...
<p class = "center">
![:scale 40%](http://www.cribbage.org/images/hall2.jpg)
</p>
...
2. **Randomness** can be used **creatively**.
...
3. I prefer **symmetric interpretations** of randomness.
