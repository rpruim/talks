...
![&nbsp;](../images/candyland-board-and-box.webp)
...
<!-- {{< video https://youtu.be/B6wJq9AZVfY?si=-hSe7CWPfE3uxR8c&t=3 width="1400" height="900" >}} -->

{{< video https://youtu.be/B6wJq9AZVfY width="12800" height="900" >}}
...
**1.** Most scientists using randomness in their models are doing so because 
...
> Since 
**the existence of ontological randomness cannot be settled scientifically**, 
such arguments are our only option... 
[The origin of randomness in the physical world] 
is a mystery which is probably impenetrable. 
The presence of **mystery should not be surprising**, however; 
if God is infinite, we would expect that much of his 
nature and actions will remain mysterious to finite 
creatures.
...
> This article argues that the scientific concept of randomness and
...
:::{.column width=50%}
<p class = "center">
![](../images/providence-and-randomness-in-nature-cover.jpg){height=650}
</p>
:::
:::
...
* [Biologos Blog](https://biologos.org/articles/randomness-and-gods-governance) (3 parts)
...
#| include: false
url <- 
    "https://rpruim.github.io/talks/random-thoughts/handong-2026/random-thoughts-handong.html"
qrcode::qr_code(url) |> 
    plot()
```

![](../images/qrcode.svg){width=75%}

<!-- <https://rpruim.github.io/talks/> -->
:::
:::{.column width=55%}
![](../images/Delight-in-Creation-book-cover.jpg){width=75%}
:::
:::
