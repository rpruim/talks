...
Reveal.on('slidechanged', function(event) {
  if (event.currentSlide.querySelector('.fragment')) {
    startFragmentLoop(event.currentSlide);
  }
});

function startFragmentLoop(slide) {
  ...
  setInterval(function() {
    ...
    fragments[current].classList.add('visible', 'current-fragment');
...
## Neil Postman's Seven Questions

- What problem does it solve?
- Whose problem is it?
- What new problems does it create?
- Which people will be most impacted by it?
- Which shifts in economic and political power will result? 
- What unintended uses will it have?
