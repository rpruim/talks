 ...
 * Plotting with `ggformula` (these are also located in the `ggformula` package)
      ...
      * Intro: [rsconnect.calvin.edu/ggformula/intro/](http://rstudio.calvin.edu:3939/ggformula/intro/)
      * Refining: [rsconnect.calvin.edu/ggformula/refining/](http://rstudio.calvin.edu:3939/ggformula/refining/)
